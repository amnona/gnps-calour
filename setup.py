...
description = 'gnps-calour is a calour interface to GNPS information files'

with open('README.md') as f:
    long_description = f.read()

keywords = 'microbiome calour gnps metabolomics database analysis bioinformatics',

setup(name='gnps-calour',
      version=0.1,
      license='BSD',
